                ...
                <div class="help-info">
                    ...
                    <div class="help-section">
                        ...
                        <ul>
                            ...
                            <li><strong>Редактирование:</strong> нажмите на значок карандаша (✎) y задачи, измените данные и сохраните.</li>
                            <li><strong>Выполнение:</strong> отметьте галочкой задачу, и она будет зачёркнута и перемещена в завершённые при фильтрации.</li>
                            <li><strong>Удаление:</strong> нажмите на крестик (x), чтобы удалить одну задачу, или используйте кнопку «Удалить выполненные задачи».</li>
                        </ul>
                    </div>
                    <div class="help-section">
                    ...
                    <div class="help-section">
                        ...
                        <ul>
                            <li>При первом запуске автоматически загружается случайный профиль c randomuser.me.</li>
